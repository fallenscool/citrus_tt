...
$(function () {
	$('.item_color-block .color').click(function (e) { 
		e.preventDefault();
		$(this).parent().find('.color').removeClass('color-active');
		$(this).addClass('color-active');
	});
	$('.item-conf .conf').click(function (r) { 
		r.preventDefault();
		$(this).parent().find('.conf').removeClass('active-conf');
		$(this).addClass('active-conf');
	});
	$('.item_links-block .link').click(function (r) { 
		r.preventDefault();
		$(this).parent().find('.link').removeClass('active-link');
